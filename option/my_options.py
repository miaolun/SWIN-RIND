...
class myNet_Options:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description="PyTorch SWIN-RIND Training")
        ...
        self.parser.add_argument('--workers', type=int, default=1, metavar='N',
        ...
        self.parser.add_argument('--epochs', type=int, default=31, metavar='N',
        ...
        self.parser.add_argument('--lr', type=float, default=1e-6, metavar='LR',
                                 help='learning rate (default: auto)') # 1e-5
        ...
        # checking point
        self.parser.add_argument('--swin-transformer', default=True, type=bool,
                                 help='if swin transformer model need to be laoded')
        self.parser.add_argument('--resume', type=str, default=None,
                                 help='put the path to resuming file if needed')
        # self.parser.add_argument('--resume', type=str,
        #                          default=r'.\model_zoo\epoch_30_checkpoint.pth.tar',
        #                          help='put the path to resuming file if needed')
        self.parser.add_argument('--checkname', type=str, default='swin-rind',
